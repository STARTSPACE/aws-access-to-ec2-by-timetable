...
sudo aws ec2 describe-security-groups --filters Name=tag:close-rdp-time,Values=11-00 Name=tag:bash-profile,Values=ad --query SecurityGroups[].[GroupId] --output text > ~/tmp/disallowrdp_ad_info.txt 2>&1
