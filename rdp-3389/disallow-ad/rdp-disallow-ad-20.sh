...
sudo aws ec2 describe-security-groups --filters Name=tag:bash-disallowrdp,Values=20-00 Name=tag:bash-profile,Values=ad --query SecurityGroups[].[GroupId] --output text > ~/tmp/disallowrdp_ad_info.txt 2>&1
