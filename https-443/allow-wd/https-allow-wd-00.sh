...
sudo aws ec2 describe-security-groups --filters Name=tag:bash-allowhttps,Values=00-00 Name=tag:bash-profile,Values=wd --query SecurityGroups[].[GroupId] --output text > ~/tmp/allowhttps_wd_info.txt 2>&1
